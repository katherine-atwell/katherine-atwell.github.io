...
![Image](https://katherine-atwell.github.io/images/projects/sycophancy-fig.png){: style="float: left" width="400px"} **Evaluating the impacts of sycophancy in LLMs using insights from behavioral economics**